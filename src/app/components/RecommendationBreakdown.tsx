  ...
  return (
    <Card className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="font-medium text-sm">Algorithm Breakdown</h4>
        
        {/* Content-Based Score */}
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Brain className="w-4 h-4 text-purple-600" />
            <span className="text-sm font-medium">Content-Based Filtering</span>
          ...
          <p className="text-xs text-gray-600">
            Matches your interests, activity level, budget, and travel style
          </p>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-auto text-sm font-semibold">
              {Math.round(scores.cfScore)}
            </span>
          </div>
          <Progress 
            value={Math.min(100, scores.cfScore)} 
            className="h-2"
          />
          <p className="text-xs text-gray-600">
            Recommended by users with similar preferences
          </p>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-auto text-sm font-semibold">
              {Math.round(scores.popularityScore)}
            </span>
          </div>
          <Progress 
            value={Math.min(100, scores.popularityScore)} 
            className="h-2"
          />
          <p className="text-xs text-gray-600">
            Based on overall ratings and visit frequency
          </p>
        </div>
      </div>
